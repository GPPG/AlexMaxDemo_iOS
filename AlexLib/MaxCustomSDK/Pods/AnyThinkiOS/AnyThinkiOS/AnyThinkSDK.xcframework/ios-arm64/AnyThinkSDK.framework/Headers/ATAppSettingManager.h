...
#import "ATModel.h"
#import "ATSafeThreadDictionary.h"
...
@property (nonatomic, strong) ATSafeThreadDictionary<NSString *, ATSharePlacementItem *> *itemDict;
@property (nonatomic, strong) ATSafeThreadArray<ATSharePlacementItem *> *sharePlacementList;
